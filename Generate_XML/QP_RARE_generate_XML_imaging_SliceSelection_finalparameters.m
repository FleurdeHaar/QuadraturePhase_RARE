...
for pe = 1:((Ny/2)+((n_img-Ny)/2))
    for rep = 1:2   % two echoes per PE step
        ...
        % Delay of TE, minus the crusher duration
        fprintf(fid, '            <DELAYATOMICSEQUENCE Delay="TE-D1-D2" DelayType="B2E" Name="D3%d" Observe="TE=P.TE, D1=Crush1img%d.RampUpTime, D2=Crush1img%d.EndOfFlatTop" StartSeq="RFimg_ref%d"/>\n', i, i,i,i);
